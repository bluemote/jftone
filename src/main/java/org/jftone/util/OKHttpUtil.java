...
public final class OKHttpUtil {
	...
	public static String CONTENT_XML = "text/xml; charset=utf-8";
	...
	public static OKHttpUtil getInstance(boolean enableCookie) {
		return getInstance(0, enableCookie, null);
	}
	...
	public static OKHttpUtil getInstance(int timeout, boolean enableCookie, Proxy proxy) {
		OKHttpUtil instance = new OKHttpUtil(enableCookie);
		if (timeout > 0) {

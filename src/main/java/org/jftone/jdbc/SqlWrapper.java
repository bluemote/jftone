...
public abstract class SqlWrapper {
	 ...
	 * @throws DbException
	 */
	public String buildUpdateSQL(String tableName, List<String> updateFields, List<String> condFields) throws DbException{
		StringBuilder sb = new StringBuilder();
		int i=0;
	 ...
	 * @throws DbException
	 */
	public String buildSelectSQL(String tableName, List<String> selectFields , List<String> condFields) throws DbException{
		StringBuilder sb = new StringBuilder();
		int i=0;
		sb.append("SELECT ");
	 ...
	 * @throws DbException
	 */
	public abstract String buildSelectSQL(String tableName, List<String> selectFields, List<String> condFields, long firstResult, int maxResults) throws DbException ;
